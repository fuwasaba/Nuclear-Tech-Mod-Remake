...
class ReactorMk1Screen(menu: ReactorMk1Menu, playerInventory: Inventory, title: Component): AbstractContainerScreen<ReactorMk1Menu>(menu, playerInventory, title) {
    private val texture = ntm("textures/gui/reactor_mk1.png")
